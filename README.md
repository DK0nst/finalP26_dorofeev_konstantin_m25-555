...
Через Swagger (POST /auth/register) создайте пользователя с email.
...
## Тестирование
Проект содержит модульные, интеграционные и мок-тесты. Для их запуска не требуются Docker или внешние сервисы.
